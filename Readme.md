...
Не стоит так делать, т.к. аналоговые устройства вносят свои искажения и в добавок мы еще имеем `clock drift`.
...
**Вывод:** На первый взгляд `AAC` хуже `SBC`, я хотел что-нибудь сказать про психоакустику, но тут все реально фигово. Плохая реализация в samsung/android?

### AAC (source=iphone 17 pro)

**Корреляция: 0.992275 | RMS: 0.112**
